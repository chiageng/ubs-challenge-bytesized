let backtracking;_579‍.x([["test",()=>test],["getNextProbableWords",()=>getNextProbableWords],["greedyMonkey",()=>greedyMonkey]]);_579‍.w("../functions/greedyMonkey",[["backtracking",["backtracking"],function(v){backtracking=v}]]);
  ...
  try {
    ...
    _579‍.g.console.log(req.body)
    const max = await backtracking(w, v, f).exec()
    console.log("receive max")
    _579‍.g.console.log(max);
    res.send("efnuiaweivu")
