let backtracking;_ad0‍.x([["test",()=>test],["getNextProbableWords",()=>getNextProbableWords],["greedyMonkey",()=>greedyMonkey],["railway_builder",()=>railway_builder]]);_ad0‍.w("../functions/greedyMonkey",[["backtracking",["backtracking"],function(v){backtracking=v}]]);
  ...
  function find_combinations(pieces, target) {
    function backtrack(pieces, start, target, currCombination, result) {
      ...
      backtrack(pieces, start, target - pieces[start], currCombination.push(pieces[start]), result);
      currCombination.pop()
