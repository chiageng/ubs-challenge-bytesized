let colonyBalcony,backtracking;_1aa‍.x([["test",()=>test],["getNextProbableWords",()=>getNextProbableWords],["greedyMonkey",()=>greedyMonkey],["colony",()=>colony],["railway_builder",()=>railway_builder]]);_1aa‍.w("../functions/colonyBalcony",[["colonyBalcony",["colonyBalcony"],function(v){colonyBalcony=v}]]);_1aa‍.w("../functions/greedyMonkey",[["backtracking",["backtracking"],function(v){backtracking=v}]]);
  ...
  try {
    ...
    return res.status(400).send(err);
       ...
       const getNextProbableWords = async (req, res) => {
  try {
    const { classes, statements } = req.body;
    _1aa‍.g.console.log(req.body);
    ...
    res.status(400).send(err);
       ...
       const greedyMonkey = async (req, res) => {
  try {
  ...
  try {
    ...
    res.status(400).send(err);
       ...
       const railway_builder = async (req, res) => {
  ...
  for (
    ...
    if (data.length < 2) {
      ...
      _1aa‍.g.console.log(data);
      let targetLength = data[0];
      _1aa‍.g.console.log(targetLength);
